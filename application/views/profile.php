            ...
            <div class="row">
                ...
                <div class="col-md-8" style="background-color: #F2F4F5;">
                	<div class=" margin-right-extra" style="margin: 20px;">
                        ...
                        <p><span class="desc">مدة العضوية: </span><?= $membership->membership_duration ?> اشهر</p>
                        <div class="row">
                        	<div class="col-md-6"><p><span class="desc">بداية الاشتراك: </span><?= $membership->invoice_start_date ?></p></div>
                        	<div class="col-md-6"><p><span class="desc">نهاية الاشتراك: </span> <?= $membership->invoice_end_date ?></p></div>
                        </div>
