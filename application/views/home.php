<section class="banner-airboard-1">
    <!-- banner included from home.css -->
</section>
...
<section class="why-choosing-efad" style="margin: 50px 50px 0px 50px;">
    <div class="row">
        <div class="col-md-4" align="center">
            ...
            <br>
            <img class="img-why-efad-sec" src="<?= base_url()."assets/".$direction; ?>/images/3.png">
            <p class="why-efad-text">الكيلو متر مفتوح</p>
            <br>
            <img class="img-why-efad-sec" src="<?= base_url()."assets/".$direction; ?>/images/6.png">
            <p class="why-efad-text">خدمة المساعدة على الطريق</p>
        </div>
        <div class="col-md-4">
            <div>
        ...
        <div class="col-md-4" align="center">
            ...
            <br>
            <img class="img-why-efad-sec" src="<?= base_url()."assets/".$direction; ?>/images/4.png">
            <p class="why-efad-text">تأمين شامل 100%</p>
            <br>
            <img class="img-why-efad-sec" src="<?= base_url()."assets/".$direction; ?>/images/5.png">
            <p class="why-efad-text" style="margin-right: 18px;">غير راضي؟</p>
            <span class="why-efad-text">استرجع المبلغ بالكامل 100%</span>
        </div>
    </div>
    <!-- <div class="col-md-3 col-sm-12">
            <div class="card custom-card">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/1.png" alt="Card image">
                    <p class="card-text">Some example text. Some example text.</p>
                </div>
            </div>
            <div class="card custom-card">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/3.png" alt="Card image">
                    <p class="card-text">Some example text. Some example text.</p>
                </div>
            </div>
            <div class="card custom-card">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/6.png" alt="Card image">
                    <p class="card-text">Some example text. Some example text.</p>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-sm-12">
            <div class="card img-fluid" style="border: none;">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/carArtboard-1.png" alt="Card image">
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-12">
            <div class="card custom-card">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/2.png" alt="Card image">
                    <p class="card-text">Some example text. Some example text.</p>
                </div>
            </div>
            <div class="card custom-card">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/4.png" alt="Card image">
                    <p class="card-text">Some example text. Some example text.</p>
                </div>
            </div>
            <div class="card custom-card">
                <div class="card-body">
                    <img class="card-img-top" src="<?= base_url()."assets/".$direction; ?>/images/5.png" alt="Card image">
                    <p class="card-text">Some example text. Some example text.</p>
                </div>
            </div>
        </div> -->
...
<section class="hire-car-conditions">
    <h1 class="text-center mb-5">ما هى شروط الحصول على سيارة؟</h1>
    <div class="banner-airboard-2"></div>
</section>
        ...
        <div class="row">
            <div class="container">
                ...
                <div class="steps">
                    <ul>
                        <li class="item">
                            <img src="<?= base_url() ?>assets/rtl/images/c1.png" class="img-fluid img1" style="width: auto;"> </li>
                        <li class="item">
                            <img src="<?= base_url() ?>assets/rtl/images/c2.png" class="img-fluid" style="width: auto;"> </li>
                        <li class="item">
                            <img src="<?= base_url() ?>assets/rtl/images/c3.png" class="img-fluid img3" style="width: auto;"> </li>
                        <li class="item">
                            <img src="<?= base_url() ?>assets/rtl/images/c4.png" class="img-fluid img4" style="width: auto;"> </li>
                        <li class="item">
                            <img src="<?= base_url() ?>assets/rtl/images/c5.png" class="img-fluid img5" style="width: auto;"> </li>
                    </ul>
                </div>
            </div>
        </div>
