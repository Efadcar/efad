            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
						<?php
                        echo form_open_multipart('cars_categories/cars_categories_edit/'.$id);
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade <?php if($i == 0){ echo "active in";} ?>" id="tab_<?= $language->lang_name ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="cc_name_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->cc_name, $language->lang_name) ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
							<textarea class="form-control" name="cc_meta_desc_<?= $language->lang_name ?>"><?= $this->global_model->getStringByKeyLanguage($row->cc_meta_desc, $language->lang_name) ?></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="cc_meta_keywords_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->cc_meta_keywords, $language->lang_name) ?>">
