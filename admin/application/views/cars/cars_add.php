								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="ckeditor form-control" rows="6" name="car_features"></textarea>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="number" class="form-control" placeholder="برجاء كتابة سعر الحجز الأساسي" name="car_yearly_price" required> 
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<div>
												<input type="checkbox" class="make-switch" data-on-text="نعم" data-off-text="لا" data-off-color="danger" data-on-color="success" value="1" name="car_in_stock" checked>
											</div>
										</div>
									</div>
								</div>
