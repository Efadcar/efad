									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control select2" id="album_uid" name="album_uid" required>
                                                ...
                                                <?php if($albums !== false){
														foreach($albums as $r) : ?>
                                                        <option value="<?php echo $r->album_uid; ?>" <?php echo set_select('album_uid', $r->album_uid); ?> <?php if($row->album_uid == $r->album_uid){echo "selected";} ?>><?php echo $r->album_name ?></option>  
                                                <?php endforeach;} ?>
											</select>
