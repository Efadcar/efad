                    ...
                    <div class="portlet-body">
                        <div class="table-responsive" style="min-height:400px">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $this->global_model->getStringByKeyLanguage('album_name'.$row->album_code, 'arabic'); ?></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?php echo site_url('albums/albums_del/'.$row->album_code) ?>" class="btn red"> حذف</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
