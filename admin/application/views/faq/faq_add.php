            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
						<?php
                        echo form_open_multipart('faq/faq_add');
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label ">
                                    <select class="form-control" name="faq_category_uid" id="form_control_1">
                                        ...
                                        ?>
                                        <option value="<?= $category->fc_uid ?>" <?php echo  set_select('fc_uid', $category->fc_uid); ?>>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade <?php if($i == 0){ echo "active in";} ?>" id="tab_<?= $language->lang_name ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="faq_question_<?= $language->lang_name ?>" value="<?php echo set_value('faq_question_'.$language->lang_name); ?>">
									...
									<textarea class="form-control ckeditor" rows="3" name="faq_answer_<?= $language->lang_name ?>"></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
							<textarea class="form-control" name="faq_meta_desc_<?= $language->lang_name ?>"></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="faq_meta_keywords_<?= $language->lang_name ?>" value="<?php echo set_value('cat_name'); ?>">
