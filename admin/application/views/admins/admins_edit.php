            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
						<?php
                        echo form_open_multipart('admins/admins_edit/'.$row->user_uid);
                        ?> 
                                ...
                                <div class="row">
									<div class="col-md-6">
										<div class="form-group form-md-line-input form-md-floating-label ">
											<input type="text" class="form-control" name="user_full_name" value="<?= $row->user_full_name ?>">
									...
									<div class="col-md-6">
										<div class="form-group form-md-line-input form-md-floating-label ">
											<input type="email" class="form-control" name="user_email" value="<?= $row->user_email ?>">
									...
									<div class="col-md-6">
										<div class="form-group form-md-line-input form-md-floating-label">
											<select class="form-control" id="form_control_1" name="group_uid">
                                                ...
                                                <?php if($groups !== false){
														foreach($groups as $r) : ?>
                                                        <option value="<?php echo $r->group_uid; ?>" <?php if($row->group_uid == $r->group_uid){echo "selected";} ?>><?php echo $r->group_name; ?></option>  
                                                <?php endforeach;} ?>
											</select>
									...
									<div class="col-md-6">
										<div class="form-group form-md-line-input form-md-floating-label">
											<select class="form-control" id="form_control_1" name="user_banned">
												<option value=""></option>
												<option value="0" <?php if($row->user_banned == 0){echo "selected";} ?>>مفعل</option>
												<option value="1" <?php if($row->user_banned == 1){echo "selected";} ?>>محظور</option>
											</select>
