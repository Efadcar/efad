            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
						<?php
                        echo form_open_multipart('faq_categories/faq_categories_edit/'.$id);
						$languages = $this->faq_categories_model->getAllLanguages();
                        ?> 
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade <?php if($i == 0){ echo "active in";} ?>" id="tab_<?= $language->lang_name ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="fc_name_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->fc_name, $language->lang_name) ?>">
                                            <label for="form_control_1">أسم القسم باللغة <?= $language->lang_title ?></label>
                                            <span class="help-block">برجاء كتابة أسم القسم باللغة <?= $language->lang_title ?></span>
                                        </div>

                                        

                                        <div class="form-group form-md-line-input form-md-floating-label ">
							<textarea class="form-control" name="fc_meta_desc_<?= $language->lang_name ?>"><?= $this->global_model->getStringByKeyLanguage($row->fc_meta_desc, $language->lang_name) ?></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="fc_meta_keywords_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->fc_meta_keywords, $language->lang_name) ?>">
