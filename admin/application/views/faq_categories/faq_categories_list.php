            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="<?php echo site_url('faq_categories/faq_categories_add') ?>" class="btn blue btn-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-toggle="modal" href="#static_<?= $row->fc_uid ?>" class="btn btn-xs red"><span class="md-click-circle md-click-animate" style="height: 62px; width: 62px; top: -18px; left: -3.09375px;"></span><i class="fa fa-trash-o"></i>حذف</a>        
                                        <div id="static_<?= $row->fc_uid ?>" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?php echo site_url('faq_categories/faq_categories_del/'.$row->fc_code) ?>" class="btn red">نعم، حذف</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
