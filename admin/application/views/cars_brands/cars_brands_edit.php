            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
						<?php
                        echo form_open_multipart('cars_brands/cars_brands_edit/'.$id);
                            ...
                            <div class="form-body">
                                <div class="fileinput fileinput-new col-md-12 text-right" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="<?= base_url().CARS_BRANDS_IMAGES.$row->cb_image ?>" alt="" style="height:100px"/>
                                    </div>
									<input type="hidden" name="cb_image" value="<?= $row->cb_image ?>" />
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade <?php if($i == 0){ echo "active in";} ?>" id="tab_<?= $language->lang_name ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="cb_name_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->cb_name, $language->lang_name) ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
							<textarea class="form-control" name="cb_meta_desc_<?= $language->lang_name ?>"><?= $this->global_model->getStringByKeyLanguage($row->cb_meta_desc, $language->lang_name) ?></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="cb_meta_keywords_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->cb_meta_keywords, $language->lang_name) ?>">
