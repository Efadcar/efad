				...
				<div class="invoice-content-2 bordered">
									...
									<tr>
										<td>
											...
											<p>
												...
												طريقة الدفع: <?php echo $row->invoice_obj->invoice_payment_method ?><br>
												حالة الدفع: <?php echo $row->invoice_obj->invoice_status ?>
											
											</p>
										</td>
										<td class="text-center sbold"><?php echo $row->invoice_obj->book_total_days ?> يوم</td>
										<td class="text-center sbold"><?php echo $row->invoice_obj->daily_rate ?> ر.س. ( لليوم الواحد )</td>
										<td class="text-center sbold"><?php echo $row->invoice_obj->invoice_total_fees ?> ر.س.</td>
									</tr>
									
									<?php 
									if($row->invoice_obj->invoice_payment_method == '<span class="label label-primary"> كاش </span>'){ 
									$row->invoice_obj->invoice_total_fees = $row->invoice_obj->invoice_total_fees + 150;
									$row->invoice_obj->invoice_total_fees_after_tax = $row->invoice_obj->invoice_total_fees_after_tax + 150;
									?>
									<tr>
										<td>
											<h3>دفع نقدي</h3>
					...
					<div class="row invoice-subtotal">
						<div class="col-xs-3">
							...
							<p class="invoice-desc"><?php echo $row->invoice_obj->invoice_total_fees ?> ر.س.</p>
						</div>
						<div class="col-xs-3">
							<h2 class="invoice-title uppercase">ضريبة (5%)</h2>
							<p class="invoice-desc"><?php echo $row->invoice_obj->invoice_tax_total ?> ر.س.</p>
						</div>
						<div class="col-xs-6">
							<h2 class="invoice-title uppercase">الإجمالي الكلي</h2>
							<p class="invoice-desc grand-total"><?php echo $row->invoice_obj->invoice_total_fees_after_tax ?> ر.س.</p>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
