            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
						<?php
                        echo form_open_multipart('blogs/blogs_edit/'.$id);
                            ...
                            <div class="form-body">
                                ...
                                <div class="fileinput fileinput-new col-md-12 text-right" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="<?= base_url().BLOGS_IMAGES.$row->blog_image ?>" alt="" style="height:100px"/>
                                    </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade <?php if($i == 0){ echo "active in";} ?>" id="tab_<?= $language->lang_name ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="blog_title_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->blog_title, $language->lang_name) ?>">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
									<textarea class="form-control" rows="3" name="blog_text_<?= $language->lang_name ?>"><?= $this->global_model->getStringByKeyLanguage($row->blog_text, $language->lang_name) ?></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
							<textarea class="form-control" name="blog_meta_desc_<?= $language->lang_name ?>"><?= $this->global_model->getStringByKeyLanguage($row->blog_meta_desc, $language->lang_name) ?></textarea>
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label ">
                                            <input type="text" class="form-control" name="blog_meta_keywords_<?= $language->lang_name ?>" value="<?= $this->global_model->getStringByKeyLanguage($row->blog_meta_keywords, $language->lang_name) ?>">
